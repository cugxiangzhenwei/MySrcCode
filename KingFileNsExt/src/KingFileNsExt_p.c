...
typedef struct _KingFileNsExt_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } KingFileNsExt_MIDL_TYPE_FORMAT_STRING;

typedef struct _KingFileNsExt_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } KingFileNsExt_MIDL_PROC_FORMAT_STRING;

typedef struct _KingFileNsExt_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } KingFileNsExt_MIDL_EXPR_FORMAT_STRING;
...
extern const KingFileNsExt_MIDL_TYPE_FORMAT_STRING KingFileNsExt__MIDL_TypeFormatString;
extern const KingFileNsExt_MIDL_PROC_FORMAT_STRING KingFileNsExt__MIDL_ProcFormatString;
extern const KingFileNsExt_MIDL_EXPR_FORMAT_STRING KingFileNsExt__MIDL_ExprFormatString;
...
static const KingFileNsExt_MIDL_PROC_FORMAT_STRING KingFileNsExt__MIDL_ProcFormatString =
    {
        0,
        {
...
static const KingFileNsExt_MIDL_TYPE_FORMAT_STRING KingFileNsExt__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IShellFolderImpl_ProxyInfo =
    {
    &Object_StubDesc,
    KingFileNsExt__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    KingFileNsExt__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _KingFileNsExt_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * const _KingFileNsExt_StubVtblList[] = 
{
...
PCInterfaceName const _KingFileNsExt_InterfaceNamesList[] = 
{
    "IShellViewImpl",
    "IShellFolderImpl",
    0
...
#define _KingFileNsExt_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _KingFileNsExt, pIID, n)

int __stdcall _KingFileNsExt_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _KingFileNsExt, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _KingFileNsExt, 2, *pIndex )
    
}

const ExtendedProxyFileInfo KingFileNsExt_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _KingFileNsExt_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _KingFileNsExt_StubVtblList,
    (const PCInterfaceName * ) & _KingFileNsExt_InterfaceNamesList,
    0, /* no delegation */
    & _KingFileNsExt_IID_Lookup, 
    2,
    2,
