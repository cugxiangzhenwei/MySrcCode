...
class LineParamEstimator : public ParameterEsitmator<CPoint2D,double> {
public:
	 ...
	 */
	virtual void estimate(std::vector<CPoint2D *> &data, std::vector<double> &parameters);
	 ...
	 *                   vector is empty (size = 0).
	 */
	virtual void leastSquaresEstimate(std::vector<CPoint2D *> &data, std::vector<double> &parameters);
	 ...
	 */
	virtual bool agree(std::vector<double> &parameters, CPoint2D &data);
