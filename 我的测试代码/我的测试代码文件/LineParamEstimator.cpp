 ...
 */
void LineParamEstimator::estimate(std::vector<CPoint2D *> &data, 
...
void LineParamEstimator::debugTest(ostream &out)
{
	...
	std::vector<CPoint2D *> pointData;

	pointData.push_back(new CPoint2D(7,7));
	pointData.push_back(new CPoint2D(-1,-1));
	...
	pointData.push_back(new CPoint2D(6,12));
	pointData.push_back(new CPoint2D(6,6));
	lpEstimator.estimate(pointData,lineParameters);
	out<<"[n_x,n_y,a_x,a_y] [ "<<lineParameters[0]<<", "<<lineParameters[1]<<", ";
	out<<lineParameters[2]<<", "<<lineParameters[3]<<" ]"<<endl;
	lpEstimator.leastSquaresEstimate(pointData,lineParameters);
	...
	pointData.push_back(new CPoint2D(7,9));
	pointData.push_back(new CPoint2D(10,9));
	lpEstimator.estimate(pointData,lineParameters);
	out<<"[n_x,n_y,a_x,a_y] [ "<<lineParameters[0]<<", "<<lineParameters[1]<<", ";
	out<<lineParameters[2]<<", "<<lineParameters[3]<<" ]"<<endl;
	lpEstimator.leastSquaresEstimate(pointData,lineParameters);
