...
{   	
	CString strFile;
	GetModuleFileName(NULL,strFile.GetBuffer(500),500);
	CString strDmpFileName = strFile;
	strFile.ReleaseBuffer();
	strDmpFileName = strDmpFileName.Mid(strDmpFileName.ReverseFind('\\')+1);
	strDmpFileName = "Dump_" + strDmpFileName.Left(strDmpFileName.ReverseFind('.')) + ".dmp";
	
	strFile = strFile.Left(strFile.ReverseFind('\\')+1) + strDmpFileName;
