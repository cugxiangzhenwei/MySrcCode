...
#ifndef __IComBase_FWD_DEFINED__
#define __IComBase_FWD_DEFINED__
typedef interface IComBase IComBase;
#endif 	/* __IComBase_FWD_DEFINED__ */
...
#ifndef __ComBase_FWD_DEFINED__
#define __ComBase_FWD_DEFINED__

#ifdef __cplusplus
typedef class ComBase ComBase;
#else
typedef struct ComBase ComBase;
#endif /* __cplusplus */

#endif 	/* __ComBase_FWD_DEFINED__ */
...
#ifndef __IComBase_INTERFACE_DEFINED__
#define __IComBase_INTERFACE_DEFINED__

/* interface IComBase */
/* [unique][helpstring][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IComBase;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("7CEC6352-7381-4733-B97A-864FEC477A71")
    IComBase : public IDispatch
    {
    public:
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE PrintMsg( 
            CHAR *msg) = 0;
    ...
    typedef struct IComBaseVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *PrintMsg )( 
            IComBase * This,
            CHAR *msg);
    ...
    interface IComBase
    {
        CONST_VTBL struct IComBaseVtbl *lpVtbl;
    };
...
#define IComBase_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IComBase_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IComBase_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IComBase_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IComBase_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IComBase_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IComBase_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define IComBase_PrintMsg(This,msg)	\
    ( (This)->lpVtbl -> PrintMsg(This,msg) ) 

#define IComBase_Sum(This,iStart,iEnd)	\
    ( (This)->lpVtbl -> Sum(This,iStart,iEnd) ) 
...
#endif 	/* __IComBase_INTERFACE_DEFINED__ */
...
class DECLSPEC_UUID("6D91A6BB-1D27-402B-9B87-5130533704FC")
CompReg;
#endif

EXTERN_C const CLSID CLSID_ComBase;

#ifdef __cplusplus

class DECLSPEC_UUID("775DE05F-1EA2-4E29-A13B-0E93D673C8F8")
ComBase;
#endif
