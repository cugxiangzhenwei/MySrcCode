...
extern const MIDL_SERVER_INFO IComBase_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IComBase_ProxyInfo;
...
/* Object interface: IComBase, ver. 0.0,
   GUID={0x7CEC6352,0x7381,0x4733,{0xB9,0x7A,0x86,0x4F,0xEC,0x47,0x7A,0x71}} */

#pragma code_seg(".orpc")
static const unsigned short IComBase_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IComBase_ProxyInfo =
    {
    &Object_StubDesc,
    ComTest__MIDL_ProcFormatString.Format,
    &IComBase_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IComBase_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    ComTest__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(9) _IComBaseProxyVtbl = 
{
    &IComBase_ProxyInfo,
    &IID_IComBase,
    IUnknown_QueryInterface_Proxy,
    ...
    0 /* (void *) (INT_PTR) -1 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IComBase::PrintMsg */ ,
    (void *) (INT_PTR) -1 /* IComBase::Sum */
};


static const PRPC_STUB_FUNCTION IComBase_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IComBaseStubVtbl =
{
    &IID_IComBase,
    &IComBase_ServerInfo,
    9,
...
{
    ( CInterfaceProxyVtbl *) &_IComBaseProxyVtbl,
...
int __stdcall _ComTest_IID_Lookup( const IID * pIID, int * pIndex )
{
    ...
    IID_BS_LOOKUP_INITIAL_TEST( _ComTest, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _ComTest, 2, *pIndex )
